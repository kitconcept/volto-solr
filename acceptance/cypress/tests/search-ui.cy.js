context('Search Acceptance Tests (UI)', () => {
  ...
  // const selectSearchContainer = '.search-input'
  const selectSearchContainer = '.search'

  it('sorting', function () {
    cy.autologout();

    cy.visit('http://localhost:3000/search');
    cy.get(`${selectSearchContainer} input`).type('colorful beta');
    cy.get(`${selectSearchContainer} button`).click();
  ...
  it('batching', function () {
    ...
    cy.visit('http://localhost:3000/search');
    cy.get(`${selectSearchContainer} input`).type('bunch');
    cy.get(`${selectSearchContainer} button`).click();
